          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>We request permission to create events in your calendar</li>
                  <li>We do not read, modify, or delete existing events in your calendar</li>
                  <li>We only create new prayer time events based on your selected date range</li>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <div className="bg-slate-50 p-4 rounded-lg">
                  ...
                  <p>Email: <a href="mailto:pro.muslimummah@gmail.com" className="text-[var(--brand-secondary)] hover:underline">mosque@pau.edu.ng</a></p>
